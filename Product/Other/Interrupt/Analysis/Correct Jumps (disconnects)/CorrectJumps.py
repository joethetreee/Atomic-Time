...
for i in range(0, len(contentsTxtCor), period):
	...
	commaLoc = 0
	for commaNum in range(oset_per): 	 	# find time
		#print("B",oset_PPS+i)
		if (commaNum == oset_per-1):
			commaLoc2 = len(line)
		else:
			commaLoc2 = commaLoc+line[commaLoc:].index(',')
...
#		print("ppsOK ",pps_dt,i,"   ",ppsPrev,ppsCur,ppsCorrection)
	...
	contentsTxtCor[i] = ""
	for commaNum in range(0,oset_per):
