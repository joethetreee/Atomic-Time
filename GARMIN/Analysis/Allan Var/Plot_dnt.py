# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 16:00:12 2016
...
ppspps_dnT = [(pps_T[i+n]-pps_T[i])/n for i in range(0,len(pps_T)-n)]
...
plt.savefig("../../Results/"+filename+"ppspps_dnT_"+str(n)+"("+str(start)+"-"+str(end)+").png", dpi=400)
plt.savefig("../../Results/"+filename+"ppspps_dnT_"+str(n)+"("+str(start)+"-"+str(end)+").svg")
